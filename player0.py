...
firstBtn = Button(window, text=" ", bg="blue", fg="white", width=5,
...
secondBtn = Button(window, text=" ", bg="blue", fg="white", width=5,
...
thirdBtn = Button(window, text=" ", bg="blue", fg="white", width=5,
...
fourthBtn = Button(window, text=" ", bg="blue", fg="white", width=5,
...
fifthBtn = Button(window, text=" ", bg="blue", fg="white", width=5,
...
sixthBtn = Button(window, text=" ", bg="blue", fg="white", width=5,
...
seventhBtn = Button(window, text=" ", bg="blue", fg="white", width=5,
...
eighthBtn = Button(window, text=" ", bg="blue", fg="white", width=5,
...
ninthBtn = Button(window, text=" ", bg="blue", fg="white", width=5,
